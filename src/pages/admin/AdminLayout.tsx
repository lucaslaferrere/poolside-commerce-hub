...
import { ArrowLeft, ClipboardList, LayoutDashboard, Package, Layers, Tag, Users, ShoppingCart, Activity, History } from 'lucide-react';
...
const TABS: TabDef[] = [
  ...
  { to: '/admin/audit-log', label: 'Actividad', icon: History },
];
