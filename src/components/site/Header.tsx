...
import { Menu, ShoppingCart, Droplet } from 'lucide-react';
    ...
    >
      <div className="container flex h-16 items-center justify-between gap-3">
        <a href="#inicio" className="flex items-center gap-2 font-display font-bold text-lg">
          <span className={cn('grid place-items-center h-9 w-9 rounded-full gradient-aqua text-primary-foreground shadow-aqua')}>
            <Droplet className="h-4 w-4" fill="currentColor" />
          </span>
          <span className={cn(scrolled ? 'text-foreground' : 'text-white drop-shadow')}>AquaLed</span>
        </a>
